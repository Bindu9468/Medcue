...
public class FakeMedicineLocalDataSource implements MedicineDataSource {
    ...
    static {
        ...
        addMedicine(1, hour, minute, "Paracetamol", "1.0", "Tablet", alarmId);
        addMedicine(2, hour + 2, minute + 1, "Crocin", "2.0", "Capsule", alarmId);

        addHistory(hour, minute, dateString, "Crocin", 2, "2.0", "Capsule", alarmId);
